...
def spc_querying_naive(g : gt.Graph, paths, y, trust_own_predictions=True, weight=None, closed_interval=False):
    '''
...
def spc_querying_with_closure(g: gt.Graph, paths, weights, y, whole_hull=True, exit_if_non_convex_partition=False):
    '''
